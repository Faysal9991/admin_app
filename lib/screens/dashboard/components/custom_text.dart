  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        color: widget.fillColor ?? Colors.black12,
        boxShadow: [
          BoxShadow(
              color: !widget.isCancelShadow! ? Colors.black.withOpacity(.1) : Colors.transparent,
      ...
      child: TextField(
        maxLengthEnforcement: MaxLengthEnforcement.enforced, maxLines: widget.maxLines,
        ...
        decoration: InputDecoration(
          ...
          border: OutlineInputBorder(
              ...
              borderSide: BorderSide(
                  color: widget.isShowBorder! ? Colors.grey.withOpacity(0.5) : Colors.transparent, width: widget.isShowBorder! ? 1 : 0)),
          ...
          focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(widget.borderRadius!),
              borderSide: BorderSide(
                  color: widget.isShowBorder! ? Colors.grey.withOpacity(0.5) : Colors.transparent, width: widget.isShowBorder! ? 1 : 1)),
          isDense: true,
          labelText:  widget.hintText,
          fillColor: widget.fillColor ?? Colors.white,
          labelStyle: Theme.of(context).textTheme.bodyMedium!.copyWith(fontSize: widget.hintFontSize, color: widget.textColor ?? Theme.of(context).hintColor),
          filled: true,
