...
class _EditPostState extends State<EditPost> {
  ...
  TextEditingController battonName = TextEditingController();
  ...
  void initState() {
    ...
    battonName.text = widget.model.battonName;
                        ...
                        children: [
                                  ...
                                  return Container(
                                    ...
                                    child: Center(
                                      child: DropdownButton(
                                        ...
                                        // Array list of items
                                        items:
                                            snapshot.data!.map((String items) {
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: provider.jobSletedvalue == null
                                  ? null
                                  : jobName.text.isEmpty ||
                                          description.text.isEmpty ||
                                          provider.jobSletedvalue!.isEmpty ||
                                          provider.selectedSubType
                                              .toString()
                                              .isEmpty ||
                                          jobDetails.text.isEmpty
                                      ? null
                                      : () {
                                          provider
                                              .update(
